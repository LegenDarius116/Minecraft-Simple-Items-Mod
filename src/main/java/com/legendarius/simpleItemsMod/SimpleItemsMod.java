...
import com.legendarius.simpleItemsMod.item.ItemAdmArm1;
...
public class SimpleItemsMod {
	...
	public void preInit(FMLPreInitializationEvent event){
		...
		adminiumHelmet_1 = new ItemAdmArm1(adminiumArmor_1, 0, 0);
		adminiumChestplate_1 = new ItemAdmArm1(adminiumArmor_1, 0, 1);
		adminiumLeggings_1 = new ItemAdmArm1(adminiumArmor_1, 0, 2);
		adminiumBoots_1 = new ItemAdmArm1(adminiumArmor_1, 0, 3);
	...
	public void init(FMLInitializationEvent event) {
		...
		// Tier 1 Adminium Armor
		GameRegistry.addRecipe(new ItemStack(adminiumHelmet_1), new Object[]{"aaa", 
																			 "a a", 'a', adminium});
		GameRegistry.addRecipe(new ItemStack(adminiumChestplate_1), new Object[]{"a a", 
																				 "aaa", 
																				 "aaa", 'a', adminium});
		GameRegistry.addRecipe(new ItemStack(adminiumLeggings_1), new Object[]{"aaa", 
																			   "a a", 
																			   "a a", 'a', adminium});
		GameRegistry.addRecipe(new ItemStack(adminiumBoots_1), new Object[]{"a a", 
																		    "a a", 'a', adminium});
	}
